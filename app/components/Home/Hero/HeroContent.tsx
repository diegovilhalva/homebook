...
const HeroContent = () => {
  return (
    <div>
      <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem] text-white'>Conhecimento que transforma vidas</h1>
      ...
      <div className="mt-8 flex items-center space-x-4">
        <button className='btn bg-green-700 hover:bg-green-900 '>Ver Cursos</button>
        <button className='btn bg-yellow-700 hover:bg-yellow-900 '>Saiba Mais</button>
      </div>
