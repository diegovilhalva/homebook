...
const MobileNav = ({closeNav,showNav}:Props) => {
  ...
  return (
    <div>
      ...
      <div className={`text-white ${navOpen} fixed flex  justify-center flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-indigo-900 space-y-6 z-[100006]`}>
        {navLinks.map((link) => (
